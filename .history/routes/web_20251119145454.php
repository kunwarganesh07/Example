...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('assign/teachers/store', [StudentController::class, 'assignteacherstore'])->name('    Route::get('assign/teachers/{id}', [StudentController::class, 'assignteacher'])->name('assign.teachers');
');
